              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="job_title" value="" class="form-control" id="job_title" placeholder="Enter Job Title">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="job_desc" value="" class="form-control editor" id="job_desc" placeholder="Enter Job Description" cols="200"> </textarea> 
                   ...
                   @endif
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" name="job_go_live_date" class="form-control pull-right" id="job_live_date" placeholder="Job live date">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" name="job_close_date" class="form-control pull-right" id="job_close_date" placeholder="Job close date">
                    </div>
